...
<body>
    ...
    <h3>
        ...
        <?php 
        $ile = $polaczenie->query("SELECT count(baza.ID) as 'ilerokordow' from baza where wiek between 10 and 18");
    ...
    $zapytanie = $polaczenie->query("SELECT baza.ID, baza.IMIE, baza.NAZWISKO, baza.WIEK from baza where wiek between 10 and 18;");
    echo "<ul>";
