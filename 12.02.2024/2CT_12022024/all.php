...
<body>
    ...
    <h3>
        ...
        <?php 
        $ile = $polaczenie->query("SELECT count(baza.ID) as 'ilerokordow' from baza");
    ...
    $zapytanie = $polaczenie->query("SELECT baza.ID, baza.IMIE, baza.NAZWISKO, baza.WIEK from baza;");
    echo "<ul>";
